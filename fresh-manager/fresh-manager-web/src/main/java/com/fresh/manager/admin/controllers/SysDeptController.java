...
public class SysDeptController extends BaseController {
    ...
    public R list() {
        ...
        if (getUserId() != Constant.SUPER_ADMIN) {
        	sysDept.setDeptFilter(sysDeptService.getSubDeptIdList(getDeptId()));
        }
        List<SysDept> deptList = sysDeptService.queryList(sysDept, null, null);
    ...
    public R info() {
        long deptId = 0;
        if (getUserId() != Constant.SUPER_ADMIN) {
            SysDept dept = sysDeptService.queryById(getDeptId());
