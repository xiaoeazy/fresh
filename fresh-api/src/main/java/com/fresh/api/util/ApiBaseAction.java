...
//    protected TokenService tokenService;
     ...
     * 参数绑定异常
     */
    @ExceptionHandler({BindException.class, MissingServletRequestParameterException.class, UnauthorizedException.class, TypeMismatchException.class,Exception.class})
    @ResponseBody
