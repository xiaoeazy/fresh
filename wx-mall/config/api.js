//const root = '/platform/api/';
 ...
 const API_BASE_URL = 'http://192.168.16.104:8080' + root;
module.exports = {
  ...
  IndexUrlChannel: API_BASE_URL + 'index/channel', //banner下的分类
   ...
   groupColonelAllList: API_BASE_URL + 'groupcolonel/allList', //获取所有未过期的的开团列表
   
    AuthLoginByWeixin: API_BASE_URL + 'auth/login_by_weixin', //微信登录
    groupList: API_BASE_URL + 'group/list', //后台团购列表
    groupQuery: API_BASE_URL + 'group/query', //单个后台团购

    groupcolonelSave: API_BASE_URL + 'groupcolonel/save', //团长创建团购
    groupcolonelList: API_BASE_URL + 'groupcolonel/list', //团长创建团购
    groupcolonelQuery: API_BASE_URL + 'groupcolonel/query', //创建团购

    SmsCode: API_BASE_URL + 'sms/smscode', //发送短信
    ...
    SelectGroupGoodsCheckout: API_BASE_URL + 'validate/validateSelectGroupGoods', // 下单前信息确认
   

    nopic: 'http://192.168.16.104:8080/api/resources/img/none.jpg' //没有图片
