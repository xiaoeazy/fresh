...
import com.fresh.gen.pojo.ColumnEntity;
import com.fresh.gen.pojo.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(config,template, tableEntity.getClassName(), config.getString("package"))));
     ...
     * 获取文件名
     */
    public static String getFileName(Configuration config,String template, String className, String packageName) {
        ...
        if (template.contains("Pojo.java.vm")) {
            return packagePath + "Pojo" + File.separator + className + "Entity.java";
        }
