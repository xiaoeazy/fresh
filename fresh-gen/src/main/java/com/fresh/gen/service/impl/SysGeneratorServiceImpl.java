package com.fresh.gen.service.impl;
...
import com.fresh.gen.mapper.SysGeneratorMapper;
import com.fresh.gen.mapper.SysOracleGeneratorMapper;
import com.fresh.gen.pojo.ResultMap;
import com.fresh.gen.service.SysGeneratorService;
import com.fresh.gen.utils.GenUtils;
...
public class SysGeneratorServiceImpl implements SysGeneratorService {
    ...
    @Autowired
    private SysOracleGeneratorMapper sysOracleGeneratorMapper;

    @Override
    public List<Map<String, Object>> queryList(Map<String, Object> map) {
        if ("ORACLE".equals(Constant.USE_DATA)) {
            List<Map<String, Object>> list = sysOracleGeneratorMapper.queryList(map);
    ...
    public int queryTotal(Map<String, Object> map) {
        if ("ORACLE".equals(Constant.USE_DATA)) {
            return sysOracleGeneratorMapper.queryTotal(map);
        }
    ...
    public Map<String, String> queryTable(String tableName) {
        if ("ORACLE".equals(Constant.USE_DATA)) {
            Map<String, String> objectMap = sysOracleGeneratorMapper.queryTable(tableName);
    ...
    public List<Map<String, String>> queryColumns(String tableName) {
        if ("ORACLE".equals(Constant.USE_DATA)) {
            List<ResultMap> list = sysOracleGeneratorMapper.queryColumns(tableName);
